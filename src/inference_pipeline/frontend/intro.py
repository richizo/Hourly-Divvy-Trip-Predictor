...
colored_header(
    label=":red[What] :orange[is the] :green[point] :blue[of this service]?",
...
st.markdown(
    ...
    - :red[Proactive Resource Allocation:] access to such predictions enables proactive re-allocation of bikes in anticipation
    ...
    - :red[Improve Customer Satisfaction:] ensuring that the appropriate number of bikes are available at all times prevents
