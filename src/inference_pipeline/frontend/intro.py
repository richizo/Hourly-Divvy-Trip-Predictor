...
st.markdown(
    ...
    One of these is Divvy, a bike-sharing system, complete with hundreds of stations and thousands of bikes & scooters. 

    Generously, Divvy's trip data has been made publicly available, and we've used it to produce this service.
    """
)
